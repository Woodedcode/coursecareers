...
# contiguous memory is vitally important for an array
#  Dynmic array is an array that can grow and shrink
...
#starting memory location + (size of each element * index baing used)
...
# data = [ 1,2,3,4,5]
# data.extend([6,7,8,9,10]) in-place - alters original memory
# print(data)
